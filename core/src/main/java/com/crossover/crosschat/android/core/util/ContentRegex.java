...
public class ContentRegex {
    ...
    private static final String HASH_SIGN_CHARS = "#";
    ...
    public static final int VALID_HASHTAG_GROUP = 3;
    ...
    static {
        synchronized (ContentRegex.class) {
            ...
            VALID_MENTION = Pattern.compile("([^a-z0-9_!#$%&*" + AT_SIGNS_CHARS
                            + "]|^|(?:^|[^a-z0-9_+~.-])RT:?)(" + AT_SIGNS + "+)([a-z0-9_]*)?",
                    Pattern.CASE_INSENSITIVE);

            VALID_EMOTICON = Pattern.compile("(\\()([a-z0-9]{1,})(\\))",
                    Pattern.CASE_INSENSITIVE);
